This program is implementing a slot machine game that uses the Shape inheritance hierarchy.
...
3) Two-dimensional arrays using array and vector, two container class templates in the C++ Standard Template Library (STL) 
4) Smart pointers 
